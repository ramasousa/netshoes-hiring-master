package com.netshoes.hiring.adressrestfull.mockpersistence.impl;
...
/**
 * Address mock persistence class
 * 
 * @author raul.sousa
 * 
 */
...
public class AddressPersistenceImpl implements AddressPersistence {
	 ...
	 * @see AddressPersistence
	 */
	public String update(Address address) throws GenericException {
